...
class TransactionModel extends Model {
    ...
    protected $allowedFields=['user_id','client_id','customer_id','company_id','code','rate','extra_code','igst','cgst','sgst','total_amount','grand_total','paid_amount','remaining_amount','total_code','created_By','recipt_no','gst_number','gst_applied','remark'];
